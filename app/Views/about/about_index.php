...
<section class="hero" id="hero">
  ...
  <div class="hero-text">
    ...
    <div class="hero-btns">
      ...
      <a href="#" class="btn-ghost" onclick="openContactModal(event)">
      <?php else: ?>
...
<section class="contact-section" id="contact">
  <div class="contact-inner">
    ...
    <?php if(!empty($email)): ?>
    <a href="#" class="btn-email" onclick="openContactModal(event)">
  ...
  <div class="proj-modal" style="max-width:520px">
    ...
    <div class="pm-body">
      ...
      <div id="contact-success" style="display:none;text-align:center;padding:20px 0">
        <div style="width:60px;height:60px;border-radius:50%;background:rgba(16,185,129,0.15);border:1px solid rgba(16,185,129,0.3);display:flex;align-items:center;justify-content:center;margin:0 auto 16px;font-size:24px;color:#10b981">
      ...
      <div id="contact-limit" style="display:none;text-align:center;padding:20px 0">
        <div style="width:60px;height:60px;border-radius:50%;background:rgba(251,191,36,0.12);border:1px solid rgba(251,191,36,0.3);display:flex;align-items:center;justify-content:center;margin:0 auto 16px;font-size:24px;color:#fbbf24">
        ...
        <div style="font-size:13px;color:var(--text-2);line-height:1.75">
          My contact form has hit its monthly message limit.<br>
          You can still reach me directly through:
        </div>
        <div style="margin-top:16px;background:rgba(255,255,255,0.03);border:1px solid rgba(99,102,241,0.2);border-radius:12px;padding:14px 18px;text-align:left">
          ...
          <div style="font-size:13px;color:var(--text);margin-bottom:6px"><i class="fas fa-envelope" style="color:#6366f1;margin-right:8px;width:14px"></i>evarsanglitanjr.320@gmail.com</div>
          <div style="font-size:12px;color:var(--text-2);margin-top:8px">You can also find my full contact info in the <strong style="color:#a5b4fc">Resume</strong> above.</div>
        </div>
      ...
      <div id="contact-error" style="display:none;text-align:center;padding:20px 0">
        <div style="width:60px;height:60px;border-radius:50%;background:rgba(239,68,68,0.12);border:1px solid rgba(239,68,68,0.3);display:flex;align-items:center;justify-content:center;margin:0 auto 16px;font-size:24px;color:#ef4444">
        ...
        <div style="font-size:13px;color:var(--text-2);line-height:1.7">Failed to send your message. Please try again or reach me directly at <strong style="color:#a5b4fc">evarsanglitanjr.320@gmail.com</strong></div>
      ...
      <div id="contact-form-wrap">
        ...
        <div style="display:flex;flex-direction:column;gap:14px">
          <div>
            ...
            <input type="text" id="contact-name" placeholder="Juan Dela Cruz"
              style="width:100%;padding:11px 14px;background:rgba(255,255,255,0.04);border:1px solid rgba(99,102,241,0.2);border-radius:10px;color:var(--text);font-family:var(--font-b);font-size:13.5px;outline:none;transition:border-color 0.2s"
          ...
          <div>
            ...
            <input type="email" id="contact-email" placeholder="juan@example.com"
              style="width:100%;padding:11px 14px;background:rgba(255,255,255,0.04);border:1px solid rgba(99,102,241,0.2);border-radius:10px;color:var(--text);font-family:var(--font-b);font-size:13.5px;outline:none;transition:border-color 0.2s"
              onfocus="this.style.borderColor='rgba(99,102,241,0.5)'"
              onblur="this.style.borderColor='rgba(99,102,241,0.2)'">
          </div>
          <div>
            ...
            <textarea id="contact-message" placeholder="Hi Evar, I'd like to discuss..." rows="5"
              style="width:100%;padding:11px 14px;background:rgba(255,255,255,0.04);border:1px solid rgba(99,102,241,0.2);border-radius:10px;color:var(--text);font-family:var(--font-b);font-size:13.5px;outline:none;transition:border-color 0.2s;resize:vertical"
              onfocus="this.style.borderColor='rgba(99,102,241,0.5)'"
          ...
          <button id="contact-submit-btn" onclick="submitContactForm()"
            style="padding:13px;background:var(--g-accent);color:#fff;border:none;border-radius:50px;font-family:var(--font-d);font-size:14px;font-weight:700;cursor:pointer;transition:all 0.2s;box-shadow:0 4px 18px rgba(99,102,241,0.35);letter-spacing:0.3px">
...
function submitContactForm() {
  ...
  // Basic validation
  if(!name) {
    valDiv.textContent = 'Please enter your name.';
    valDiv.style.display = 'block'; return;
  }
  if(!email || !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)) {
    valDiv.textContent = 'Please enter a valid email address.';
    valDiv.style.display = 'block'; return;
  }
  if(!message) {
    valDiv.textContent = 'Please enter a message.';
    valDiv.style.display = 'block'; return;
  }
  ...
  // Send via EmailJS
  emailjs.send('service_ila4gut', 'template_7qxz387', {
    from_name:  name,
    from_email: email,
    message:    message,
  })
  ...
  .catch(function(error) {
    ...
    // Check if limit reached (EmailJS error code 429 or specific message)
